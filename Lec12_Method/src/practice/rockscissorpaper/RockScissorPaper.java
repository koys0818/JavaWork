	...
	public static void displayChoice(int user, int com) {
		...
		if(user == 1) {
			if(com == 1) {
				...
				System.out.println("가위 vs 바위");
			}
			else if(com == 3) {
				System.out.println("가위 vs 보");
			}
		}
		else if(user == 2) {
			if(com == 1) {
				System.out.println("바위 vs 가위");
			}
			else if(com == 2) {
				System.out.println("바위 vs 바위");
			}
			else if(com == 3) {
				System.out.println("바위 vs 보");
			}
		}
		else if(user == 3) {
			if(com == 1) {
				System.out.println("보 vs 가위");
			}
			else if(com == 2) {
				System.out.println("보 vs 바위");
			}
			else if(com == 3) {
